...
__declspec(dllexport) void scMathAbs(JObject *c, void *userdata) {
    if ( scIsInt("a") ) {
...
__declspec(dllexport) void scMathRound(JObject *c, void *userdata) {
    if ( scIsInt("a") ) {
...
__declspec(dllexport) void scMathMin(JObject *c, void *userdata) {
...
__declspec(dllexport) void scMathMax(JObject *c, void *userdata) {
    if ( (scIsInt("a")) && (scIsInt("b")) ) {
...
__declspec(dllexport) void scMathRange(JObject *c, void *userdata) {
...
__declspec(dllexport) void scMathSign(JObject *c, void *userdata) {
    if ( scIsInt("a") ) {
...
__declspec(dllexport) void scMathE(JObject *c, void *userdata) {
    scReturnDouble(k_E);
}

//Math.log(a) - returns natural logaritm (base E) of given value
__declspec(dllexport) void scMathLog(JObject *c, void *userdata) {
    scReturnDouble( log( scGetDouble("a") ) );
}

//Math.log10(a) - returns logaritm(base 10) of given value
__declspec(dllexport) void scMathLog10(JObject *c, void *userdata) {
    scReturnDouble( log10( scGetDouble("a") ) );
}

//Math.exp(a) - returns e raised to the power of a given number
__declspec(dllexport) void scMathExp(JObject *c, void *userdata) {
    scReturnDouble( exp( scGetDouble("a") ) );
}

//Math.pow(a,b) - returns the result of a number raised to a power (a)^(b)
__declspec(dllexport) void scMathPow(JObject *c, void *userdata) {
    scReturnDouble( pow( scGetDouble("a"), scGetDouble("b") ) );
}

//Math.sqr(a) - returns square of given value
__declspec(dllexport) void scMathSqr(JObject *c, void *userdata) {
    scReturnDouble( ( scGetDouble("a") * scGetDouble("a") ) );
}

//Math.sqrt(a) - returns square root of given value
__declspec(dllexport) void scMathSqrt(JObject *c, void *userdata) {
    scReturnDouble( sqrt( scGetDouble("a") ) );
}

__declspec(dllexport) void scMathAvg(JObject *c, void *data) {
    // Array abrufen
